 ...
 *
 * 2013 - edited by Vittorio Cuculo <vittorio@dotdotdot.it>
 *
 * Changelog:
 *   - Added support to two lines horizontal scrolling / e.g. ledMatrix.hscrolltexts(0, 'text1', 1, 50, 8, 'text2', 1);
 */
...
public:
    ...
    void hscrolltexts(int y1, char *text1, uint8_t color1, int delaytime, int y, char *text2, uint8_t color2,
                      int times = 1, uint8_t dir = LEFT, uint8_t attr1 = 0, uint8_t bgcolor1 = BLACK, uint8_t attr2 = 0, uint8_t bgcolor2 = BLACK);
    ...
    void puttext(int x, int y, char *text, uint8_t color = GREEN, uint8_t bgcolor = BLACK);
